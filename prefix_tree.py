...
class Trie:
    ...
    def _suggestionRec(self, root, word, word_list):
        ...
        for ch, node in sorted(root.children.items()):
            self._suggestionRec(node, word + ch, word_list)
...
if __name__ == "__main__":
    ...
    t.insertNode("help")
    t.insertNode("helps")
    t.insertNode("helpinggg")
    t.insertNode("helping")
    t.insertNode("dog")
    t.insertNode("heaping")
    print(t.getAutoSuggestion('H'))
